        ...
        <div>
            ...
            <div id="wd-css-navigating-with-cards">
                ...
                <Card style={{ width: "18rem" }}>
                    <Card.Img variant="top" src="images/james_holden.jpg" />
                    <Card.Body>
                        <Card.Title>James Holden</Card.Title>
                        <Card.Text>
                            The captain of the Rocinante.
                        </Card.Text>
                        <Button variant="primary">Good Books</Button>
                    </Card.Body>
                </Card>
            </div>
        </div>
